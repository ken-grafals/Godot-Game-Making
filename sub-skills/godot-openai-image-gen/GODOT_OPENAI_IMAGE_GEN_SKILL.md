# Godot OpenAI Image Generation (Sub-Skill)

This sub-skill covers AI art generation for Godot game projects using OpenAI's image APIs — the full pipeline from generation to production-ready sprites.
...
Install: `pip install "rembg[cpu]"`. First run downloads a ~176MB model to `~/.u2net/`.
